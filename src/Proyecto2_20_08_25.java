...
class Lamina extends JPanel{
    ...
    JButton boton1, boton2, boton3, boton4, boton5, boton6; // añadidos boton5 y boton6
    ...
    public Lamina(){
        ...
        boton5 = new JButton("Sumar menores");    // nuevo
        boton6 = new JButton("Sumar impares");   // nuevo
        ...
        boton5.addActionListener(new GestionEventos()); // nuevo
        boton6.addActionListener(new GestionEventos()); // nuevo
    ...
    private class GestionEventos implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource()==boton1){
            ...
            } else if(e.getSource()==boton5){ // Sumar menores
                objeto.crearArreglo();
                JOptionPane.showMessageDialog(null,
                        "Arreglo:\n"+objeto.mostrarArreglo(objeto.MAX-1));
                x = Integer.parseInt(
                ...
                JOptionPane.showMessageDialog(null,
                        "Arreglo:\n"+objeto.mostrarArreglo(objeto.MAX-1)
                                +"\n La suma de los elementos menores que "+x+" es: "+
                                objeto.sumarMenores(objeto.MAX-1, x));
            } else if(e.getSource()==boton6){ // Sumar impares
                objeto.crearArreglo();
                JOptionPane.showMessageDialog(null,
                        "Arreglo:\n"+objeto.mostrarArreglo(objeto.MAX-1)
                                +"\n La suma de los elementos impares es: "+
